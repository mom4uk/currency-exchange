...
var (
	...
	ErrAbsenceOfExchangeRateFieldForUpdate = errors.New("rate field is missing")
	ErrInvalidCurrencyField                = errors.New("incorrect fields values")
	ErrInvalidCurrencySign                 = errors.New("too long value in sign field")
